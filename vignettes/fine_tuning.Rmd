...
triplet_text_dataset <- torch::dataset(
  ...
  initialize = function(df, n_tokens = 64) {
    # First we need to tokenize everything and add BERT [CLS], [SEP], and [PAD]
    # tokens to standardize the inputs. We simplify the token vectors to a
    # matrix for each input.
